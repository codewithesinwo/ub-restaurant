    ...
    >
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-4xl font-bold text-gray-900 mb-1 group-hover:text-amber-600 transition-colors">{value}</p>
        ...
        <div className={`p-4 rounded-2xl bg-gradient-to-br ${trend === 'up' ? 'from-emerald-500/10 to-emerald-600/10' : 'from-red-500/10 to-red-600/10'} border border-white/50 group-hover:scale-110 transition-all`}>
