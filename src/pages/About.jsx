...
const About = () => {
	...
	return (
		<div className="min-h-screen bg-gray-50">
			<Section className="pt-32 pb-24 bg-amber-950 text-white">
			...
			<Section id="mission" className="bg-white py-20">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-2xl mx-auto">
						We don’t just feed you — we make your meal moments memorable. Online
						payment, cash on delivery, and 7-day customer support.
					</p>
				</div>
					...
					{whyUs.map((item, index) => (
						<motion.div
							...
							<Card className="h-full p-10 hover:shadow-xl transition-all duration-300 group">
								<div
									className={`w-20 h-20 bg-gradient-to-br ${item.color} rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-lg group-hover:scale-110 transition-transform`}>
