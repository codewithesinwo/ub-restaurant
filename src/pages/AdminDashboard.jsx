...
const AdminDashboard = () => {
  ...
  const totalRevenue = orders.reduce((sum, order) => sum + order.total, 0).toFixed(0);
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center p-12">
          ...
          <p className="text-xl text-gray-600 mb-8">Please log in to access the admin dashboard</p>
          <Button as="link" href="/admin/login" size="lg">Go to Login</Button>
        </div>
      </div>
    );
  }
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
      <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
        <div>
          ...
          <p className="text-xl text-gray-600">Welcome back! Here's what's happening with your restaurant.</p>
        </div>
        <Button 
          size="lg" 
          ...
          <div className="bg-gradient-to-br from-emerald-500/5 to-blue-500/5 border border-emerald-200/50 rounded-3xl p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-4 bg-white rounded-2xl">
                ...
                <div className="text-2xl font-bold text-amber-600">$38.50</div>
              </div>
            </div>
          </div>
        </div>
